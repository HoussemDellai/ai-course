# resource "azurerm_container_app" "aca_gemma4_e2b_it_t4" {
#   container_app_environment_id = azurerm_container_app_environment.aca_environment.id
#   name                         = "gemma-4-e2b-it-t4"
...
# output "aca_gemma4_e2b_it_t4_fqdn" {
#   value = azurerm_container_app.aca_gemma4_e2b_it_t4.ingress.0.fqdn
# }

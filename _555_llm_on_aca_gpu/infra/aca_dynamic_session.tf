resource "azapi_resource" "aca_session_pool" {
...
resource "azurerm_role_assignment" "aca_env_session_pool_contributor" {
  scope                = azapi_resource.aca_session_pool.id
...
data "azapi_resource_action" "sessionpool_apikey" {
  type        = "Microsoft.App/sessionPools@2025-02-02-preview"
  resource_id = azapi_resource.aca_session_pool.id

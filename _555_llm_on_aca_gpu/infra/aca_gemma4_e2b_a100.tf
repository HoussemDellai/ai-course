# resource "azurerm_container_app" "aca_gemma4_e2b_it_a100" {
#   container_app_environment_id = azurerm_container_app_environment.aca_environment.id
#   name                         = "gemma-4-e2b-it-a100"
...
#         "--limit-mm-per-prompt", jsonencode({ "images" : 1, "videos" : 1, "audios" : 1 }),
#         "--host", "0.0.0.0",
#         "--port", "8000"
#       ]
...
# output "aca_gemma4_e2b_it_a100_fqdn" {
#   value = azurerm_container_app.aca_gemma4_e2b_it_a100.ingress.0.fqdn
# }
